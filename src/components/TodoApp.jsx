...
// Aplica estilo para o botão de deletar
  margin-left: 10px; // Adiciona uma margem a esquerda do elemento
  padding: 5px 10px; // Adiciona um padding vertical e horizontal
  background-color: red; // Define a cor de fundo como vermelho
  color: white; // Define a cor do texto como branco
  border: none; // Retira a bordas do elemento
  border-radius: 5px; //Adiciona bordas arredondadas
  transition: 0.5s ease; // Adiciona o tempo para uma transição 
  &:hover{
    cursor: pointer; // Define o cursor como pointer quando passar o mouse
...
// Aplica estilo para o botão de Alterar
  ...
  margin-left: 10px; // Adiciona uma margem a esquerda do elemento
  padding: 5px 10px; // Adiciona um padding vertical e horizontal
  background-color: #007bff; // Define a cor de fundo como um azul
  color: white; // Define a cor do texto como branco
  border: none; // Retira a bordas do elemento
  border-radius: 5px; //Adiciona bordas arredondadas
  ...
  &:hover{
    cursor: pointer; // Define o cursor como pointer quando passar o mouse
    background-color: #0056b3; // Muda a cor de fundo quando passar o mouse
  }
`;
